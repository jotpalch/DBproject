...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { lat: @history.lat, lng: @history.lng, q: @history.q } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { lat: @history.lat, lng: @history.lng, q: @history.q } }
